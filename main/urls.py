...
from . import views, views_company, views_vehicle
...
urlpatterns = [
    ...
    # path('answer_session/<int:vehicle_id>/<int:question_type_id>', views_answer_session.questions_answer_session, name='main-answer_session'),
